...
int main()
{
 ...
 std::cout<<"\nMatrix Multiplication by ones:"<<std::endl;
 printVector<double>((CSR_A*y));
 std::cout << "\nExtract the second coloumn:"<<std::endl;
 printVector<double>((CSR_A*e2));
 /* ---------------END CSR FORMAT ------------*/
