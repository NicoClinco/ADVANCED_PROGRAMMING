...
extra_compile_args_q  =['--std=c++17','-lgsl','-lglcblas'];

EIGEN_PATH = '/home/nico/Desktop/PHD-COURSES/libraries/eigen/include/eigen3'
GLS_PATH = '/home/nico/Desktop/PHD-COURSES/libraries/gsl'+'/include'
...
ext_modules = [
    ...
    Extension(
        'quadBind',
        [quad_path+'Quadrature.hpp',q_bind_path+'quadBind.cpp'],
